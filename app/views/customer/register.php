...
<div class="container register-container mb-5">
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-body p-4">
            <h3 class="text-center mb-2 text-primary">Dimsum Cece</h3>
            <h5 class="text-center text-muted mb-4">Buat Akun Pelanggan</h5>
            ...
            <form action="<?= BASEURL; ?>/auth/register" method="POST">
                ...
                <button type="submit" class="btn btn-primary w-100 rounded-pill mb-3">Daftar Akun</button>
            </form>

            <div class="text-center">
                <p class="mb-0 text-muted">Sudah memiliki akun? <a href="<?= BASEURL; ?>/auth/login" class="text-decoration-none">Login di sini</a></p>
            </div>
        </div>
    </div>
</div>
