...
<head>
    ...
    <title>Tambah Produk - Admin Dimsum Cece</title>
    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <h5 class="mb-0"><i class="fa fa-plus-circle me-2 text-primary"></i>Tambah Produk Baru</h5>
            </div>
                        ...
                        <form action="<?= BASEURL; ?>/produk/tambah" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_produk" name="nama_produk"
                                       ...
                                       placeholder="Contoh: Siomay Ayam" required>
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_best_seller"
                                           ...
                                           <?= isset($_POST['is_best_seller']) ? 'checked' : ''; ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="deskripsi" name="deskripsi"
                                          rows="3" placeholder="Deskripsi singkat produk..."><?= htmlspecialchars($_POST['deskripsi'] ?? ''); ?></textarea>
                            </div>
